# Kickoff — build the Google News Latest MVP
...
> Start the **Google News Latest MVP** build on the **`projects`** kanban board. First read
> `/root/Hermes/projects/sd-google-news-latest-backend-mvp-v2026.06.30.1/AGENTS.md`, `docs/system-design.md`, and `docs/mvp-scope.md`. Then create the dependency
...
> on the previous and shares `--workspace dir:/root/Hermes/projects/sd-google-news-latest-backend-mvp-v2026.06.30.1`. Make build cards goal-loop. Then let the board
...
B="--board projects"
WS="--workspace dir:/root/Hermes/projects/sd-google-news-latest-backend-mvp-v2026.06.30.1"
...
```bash
~/Hermes/bin/e2e-verify register /root/Hermes/projects/sd-google-news-latest-backend-mvp-v2026.06.30.1   # join the shared 30m acceptance cron
~/Hermes/bin/e2e-verify run /root/Hermes/projects/sd-google-news-latest-backend-mvp-v2026.06.30.1         # confirm green now; red -> self-files fix cards to projects
```
